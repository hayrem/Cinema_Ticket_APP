<div class="sidebar" style="min-height: 100vh;">
    ...
    <ul class="sidebar-list">
        ...
        <li class="sidebar-list-item <?= urlIs('/seller/create_movie') ? 'active' : '' ?>">
            <a href="/seller/create_movie">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-shopping-bag">
                    <path d="M6 2L3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4z" />
                    <line x1="3" y1="6" x2="21" y2="6" />
                    <path d="M16 10a4 4 0 0 1-8 0" />
                </svg>
                <span class="fs-6">Add new movie</span>
            </a>
        </li>
        <li class="sidebar-list-item <?= urlIs('/seller/create_show') ? 'active' : '' ?>">
            <a href="/seller/create_show">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-shopping-bag">
                    <path d="M6 2L3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4z" />
                    <line x1="3" y1="6" x2="21" y2="6" />
                    <path d="M16 10a4 4 0 0 1-8 0" />
                </svg>
                <span class="fs-6">Add show</span>
            </a>
        </li>
    </ul>
</div>