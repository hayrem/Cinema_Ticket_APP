            ...
            <form action="/seller/setting" class="bg-white  p-4 shadow-lg" style="width: 80%;border-radius:10px;" method="post">
                <div class="row mb-3">
                    ...
                    <div class="col">
                        ...
                        <select class="form-select p-2" aria-label="Default select example" name="genre"><?= $editMovie['genre']?>
                ...
                <div class="mb-3">
                    ...
                    <textarea  class="form-control" name="description" id="exampleFormControlTextarea1" style="height: 100px" rows="15" col="200"><?= $editMovie['description']?></textarea>
                </div>
