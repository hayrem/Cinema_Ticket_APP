                 ...
                 foreach ($sellerShows as $show): ?>
                    <div class="card-detail">
                        ...
                        <div class="card-body-detail">
                            ...
                            <p class="card-text">Language: <?php echo $show["language"]; ?></p>
                            <p class="card-text">Release: <?php echo $show["released"]; ?></p>
                            <p class="card-text"><?php echo $show["description"]; ?></p>
                            <p class="card-text"></p>
                            <div class="d-flex justify-content-between ">
                                <a href="/edit?id=<?php echo $show["movie_id"]; ?>" class="btn btn-outline-danger bg-danger text-white">Edit</a>
                                <a type="submit" href="/delete?id=<?php echo $show['movie_id']?>"> DELETE</a>  
                            </div>
